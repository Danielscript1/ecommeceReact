...
import { mudarCarrinho,mudarQuantidade  } from 'store/reducers/carrinhos';
...
export default function Item(props) {
  ...
  const estaNoCarrinho = useSelector(state => state.carrinhos.some(itemNoCarrinho => itemNoCarrinho.id === id));
